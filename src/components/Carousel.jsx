...
console.log(pkg)
  ...
  return (
    <div className={`section products ${styles["products"]}`} id="products">
      <div className="container-skel">
        {/* row */}

        <div className="row">
          <div className="eight columns offset-by-two sectitle">
            <div className="title">
              <h2 className={styles["title"]}>
                Check out our Heat Pump and Induction appliances
              </h2>
            </div>
          </div>
        </div>
        ...
        <div className={`row ${styles["row"]}`}>
          <div className="ten columns offset-by-one">
            <h2 className={styles["sub-title"]}>Heat Pump Laundry</h2>
            {/* product-carousel */}
           {/*  <Slider client:only="react"
              {...settings}
              className={`product-carousel slick-dotted ${styles["product-carousel"]}`}
            >
              {cards
                .filter((card) => card.category === "laundry")
                .map((card) => {
                  return (
                    <div
                    ...
                    >
                      ...
                      <div className={`cta ${styles["cta"]}`}>
                        <a
                          ...
                          data-ms-action={`${card.title} - click`}
                          data-ms-label={card.sku}
                          href={card.link}
                          className="newbtn"
                        >
                          SHOP NOW
        ...
        <div className={`row ${styles["row"]}`}>
          <div className="ten columns offset-by-one">
            <h2 className={styles["sub-title"]}>Induction Cooking</h2>
            {/* product-carousel */}
           {/*  <Slider 
            client:only="react"
              {...settings}
            ...
            >
              {cards
                .filter((card) => card.category === "induction")
